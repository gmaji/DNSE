...
public class Ranker_X_MDDPlus extends Ranker {
	public int precision;
	 public int r;
	 public Ranker_X_MDD myRanker_mdd;
	 
	/*public MyRanker(IndexedGraph graph) {
		super(graph);
	}*/
	public Ranker_X_MDDPlus(IndexedGraph graph, Ranker_X_MDD myRanker_mdd,  int r, int precision) {
		super(graph);
		this.myRanker_mdd = myRanker_mdd;
		this.r=r;
	...
	public void evaluate() {
		System.out.println("Start: MyRanker_MDDPlus.evaluate():: Time: "+new Date());
		preProcessing();

				
		double[] thetaMap = myRanker_mdd.nodeValues;
		...
		System.out.println("End: MyRanker_MDDPlus.evaluate():: Time: "+new Date());
	  }
